    ...
    <>
        <aside id="layout-menu" className="layout-menu menu-vertical menu bg-menu-theme">
            ...
            <ul className="menu-inner py-1">
              ...
              <li className={`menu-item ${isAccountSettingOpen ? 'open' : ''}`}>
              <a href="javascript:void(0);" className="menu-link menu-toggle" onClick={toggleAccountSetting}>
              ...
              <li className={`menu-item ${isAuthenticationOpen ? 'open' : ''}`}>
                <a href="javascript:void(0);" className="menu-link menu-toggle" onClick={toggleAuthentication}>
